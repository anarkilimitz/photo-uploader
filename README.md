...
Серверлесс-обработка (Lambda): Альтернативный (или фоновый) механизм — при попадании原始ного (оригинального) файла в облако, срабатывает AWS Lambda-функция, которая создает отдельный файл *_preview.jpg.
